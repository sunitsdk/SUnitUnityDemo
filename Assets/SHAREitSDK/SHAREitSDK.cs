...
namespace SHAREitSDK {
    public class SHAREitSDK : MonoBehaviour
    {
        ...
        public const string ACTION_TYPE_RECHARGE_RESULT = "rechargeResult";
        ...
        private RechargeResultListener rechargeResultListener = null;
        ...
        public void onHandleShareitSdk(string paras)
        {
            ...
            switch (actionType)
            {
                ...
                case ACTION_TYPE_SHOW_RATE_FAIL:
                    ...
                    break;
                case ACTION_TYPE_RECHARGE_RESULT:
                    if (rechargeResultListener != null)
                        rechargeResultListener.onResult((int)jsonData["code"], (string)jsonData["orderId"], (string)jsonData["message"], (string)jsonData["reference"]);
                    break;
        ...
        public void recharge(MerchantParamBean merchantParamBean, RechargeResultListener rechargeResultListener)
        {
